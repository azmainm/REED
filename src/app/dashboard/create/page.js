...
// Dummy story data for regeneration
const dummyStory = `{
  ...
  "scenes": [
    {
      "id": 1,
      "text": "Greetings! I am Socrates. Today, we will explore the nature of knowledge through dialogue. Are you ready to begin our intellectual journey?",
      "choices": null
    },
    {
      "id": 2,
      "text": "Excellent! Let us start with a simple question: What is knowledge? Many claim to know many things, but what does it truly mean to know something?",
      "choices": null
    },
    {
      "id": 3,
      "text": "An interesting perspective. Let's examine it further. If knowledge requires certainty, then would you agree that much of what we claim to know might not be knowledge at all?",
      "choices": null
    }
  ]
}`;
...
export default function CreatePage() {
  ...
  const [storyText, setStoryText] = useState(dummyStory);
        ...
        {currentStep === 3 && (
          <div>
            ...
            <button
              ...
              className="inline-flex items-center justify-center rounded-lg border border-border bg-transparent px-4 py-2 text-sm font-medium hover:bg-accent transition-colors"
            >
